...
function Hero({
  ...
  return (/*#__PURE__*/
            _jsxs("section", { id: "top", className: "relative isolate scroll-mt-40 overflow-hidden rounded-[2rem] border border-[#D9C7B6] bg-stone-950 shadow-[0_28px_80px_rgba(78,58,40,0.22)]", children: [/*#__PURE__*/
                                    _jsx("img", { src: "https://images.unsplash.com/photo-1676387794914-e6be10e6a57b?auto=format&fit=crop&w=1800&q=85", alt: "Warm living room with reused furniture", className: "absolute inset-0 h-full w-full object-cover object-center" }), /*#__PURE__*/
